...
const fieldClasses =
  'rounded-lg border border-slate-300 bg-white px-3 py-2 text-brand-ink placeholder:text-slate-400 transition-colors duration-150 focus-visible:outline focus-visible:outline-2 focus-visible:outline-brand-green focus-visible:border-brand-green'
