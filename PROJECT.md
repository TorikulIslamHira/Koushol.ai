...
| 17 | Growth & sharing: referral program (invite credit for both sides), certificate social share (depends on Phase 9), public teacher profile page (also the entry point for Phase 10's deferred "notify me" waitlist on unpublished courses), course preview/trailer on the detail page | Planned |
